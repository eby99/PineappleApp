        ...
        no-underline hover:no-underline font-title" href="#" title="" aria-label="store logo">
                        ...
                        <div class="relative mr-2 level-0">
                            <span class="flex items-center block p-3 text-md bg-opacity-95">
                                <a data-test="header-link" 
                                   class="w-full py-3 text-base text-gray-700 transition-colors duration-200 hover:text-green-500 active:text-green-700 focus:text-green-500"
                                   href="#" 
            ...
            <div class="flex items-center order-3">
                ...
                <div class="relative inline-block ml-1 sm:ml-3">
                    <a data-test="header-icon" 
                       href="#" 
                       id="customer-menu"
                       class="block transition-colors duration-200 hover:text-green-500 active:text-green-700" 
                ...
                <a
                    ...
                    id="menu-cart-icon"
                    class="relative inline-block ml-1 sm:ml-3 transition-colors duration-200 hover:text-green-500 active:text-green-700"
                    href="#"
                >
